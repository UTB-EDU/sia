...
Sys.Res={
"urlMustBeLessThan1024chars":"El estado de historial debe ser lo suficientemente pequeño como para que la URL no tenga más de 1024 caracteres.",
"argumentTypeName":"El valor no es el nombre de un tipo existente.",
"methodRegisteredTwice":"Ya se ha registrado el método {0}.",
"cantSetIdAfterInit":"La propiedad id no se puede definir en este objeto una vez inicializado.",
...
"typeShouldBeTypeOrString":"El valor no es un tipo ni un nombre de tipo válido.",
"historyInvalidHistorySettingCombination":"No se puede establecer enableHistory en false cuando ScriptManager.EnableHistory es true.",
...
"eventHandlerNotFound":"No se encontró el controlador.",
...
"namespaceContainsObject":"Ya existe el objeto {0} y no es un espacio de nombres.",
...
"appComponentMustBeInitialized":"Deben inicializarse los componentes para poder agregarlos al objeto Application.",
...
"historyMissingHiddenInput":"Para que la característica de historial funcione en Safari 2, la página debe tener un elemento de entrada oculto con el id. \u0027__history\u0027.",
...
"scriptLoadMultipleCallbacks":"El script \u0027{0}\u0027 contiene varias llamadas a Sys.Application.notifyScriptLoaded(). Sólo se permite una.",
...
"webServiceInvalidJsonWrapper":"El método de servidor \u0027{0}\u0027 ha devuelto datos no válidos. Falta la propiedad \u0027d\u0027 en el contenedor de JSON.",
